    ...
    <div className="screen-line-after flex border-x border-edge">
      <div className="shrink-0 border-r border-edge">
        <div className="mx-[2px] my-[3px]">
          <Image
            className="size-32 rounded-full ring-2 ring-blue-500/30 ring-offset-2 ring-offset-background transition-transform duration-500 select-none hover:scale-105 sm:size-40"
