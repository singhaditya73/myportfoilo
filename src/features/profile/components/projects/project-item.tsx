      ...
      <div className={className}>
        <div className="flex items-center">
          ...
          <div className="flex-1 border-l border-dashed border-edge">
            <AccordionPrimitive.Trigger className="group/project flex w-full items-center justify-between gap-4 p-4 pr-2 text-left transition-colors duration-200 select-none hover:bg-muted/40 [&[data-state=open]_.lucide-chevron-down]:rotate-180">
              <div>
